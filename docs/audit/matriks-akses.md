...
| **Stok Masuk** | Gud | Gud (dapat pula membuat *Barang baru* dari isian nota; **sejak 21 Sep 2026 kode barang wajib unik per kategori**, A-021; **sejak 25 Sep 2026 kode barang tepat 6 digit angka**) | — | — | **Impor Stok Masuk + Unduh Template (Gud)** — jenis transaksi dipilih di pop-up dari sumber Catat Stok Masuk; tanggal, nomor dasar, dan keterangan per baris; dicatat lewat `StokService::tambah()`; Stok Awal hanya untuk barang yang belum pernah punya stok/mutasi (25 Sep 2026, menggantikan Impor Stok Awal) | — | `StokMasuk.php:75` |
