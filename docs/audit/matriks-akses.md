...
| **Stok Masuk** | Gud | Gud (dapat pula membuat *Barang baru* dari isian nota; **sejak 21 Sep 2026 kode barang wajib unik per kategori**, A-021) | — | — | — | — | `StokMasuk.php:59` |
| **Barang Persediaan** | Adm, Kas | Adm, Kas | Adm, Kas (`stok_fisik` dengan dialog konfirmasi; **`stok_hold` kini hanya tampil, tidak dapat diubah — diperbaiki 21 Sep 2026, A-030**) | Adm, Kas (dilindungi bila punya riwayat) | — | — | `BarangPersediaanResource.php:48` |
| **Kategori Barang** | Adm, Kas | Adm, Kas | Adm, Kas | Adm, Kas (dilindungi) | — | — | `KategoriResource.php:48` |
